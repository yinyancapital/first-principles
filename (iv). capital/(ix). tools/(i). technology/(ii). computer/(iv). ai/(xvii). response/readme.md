...
i. **outputs are selected predictions.**  
   responses come from choosing probable next [token](../%28xv%29.%20token/readme.md) units under constraints.
...
**response** = **the model-generated output produced from a [prompt](../%28xvi%29.%20prompt/readme.md), intended to satisfy the user's objective within given constraints.**  
it is predicted [language](../%28xiv%29.%20language/readme.md) shaped for usefulness.
