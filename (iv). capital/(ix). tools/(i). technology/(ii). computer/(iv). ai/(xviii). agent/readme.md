...
**agent** = **an ai system that can plan and take multi-step actions toward a goal by using [prompt](../%28xvi%29.%20prompt/readme.md), [tool](../../../../readme.md), memory, and feedback from results.**  
